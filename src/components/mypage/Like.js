  ...
  return <LikeS>
      ...
      <BlankS display='flex' width='40%' height='12vh' background=''>
        ...
        <BlankS width='40%' background=''>
          <BlankS display='flex'>
            <BlankS width='80%' marginleft='5%' fontsize='150%' textalign='left'>사과, 나무, 문어 그림</BlankS>
            <BlankS width='20%' marginleft='auto'>
              <IconBoxS width='40%' src='https://img.icons8.com/office/256/filled-like.png' border='0'></IconBoxS>
            </BlankS>
          </BlankS>
          <BlankS marginleft='5%' textalign='left'>그림파는샵</BlankS>
            <BlankS width='20%' marginleft='5%' margintop='3%' textalign='left' background=''>100 원</BlankS>
          <BlankS width='100%' background=''>
            <ButtonS width='45%' fontsize='120%'>구매</ButtonS>
            <ButtonS width='45%' fontsize='120%' marginleft='3%' margintop='2%'>장바구니</ButtonS>
          </BlankS>
        </BlankS>
      </BlankS>
      ...
      <BlankS display='flex' width='40%' height='12vh' background=''>
        ...
        <BlankS width='40%'>          
          ...
          <BlankS marginleft='5%' margintop='3%' textalign='left'>5000 원</BlankS>
          <BlankS width='100%' background=''>
            <ButtonS width='45%' fontsize='120%'>구매</ButtonS>
            <ButtonS width='45%' fontsize='120%' marginleft='3%' margintop='2%'>장바구니</ButtonS>
          </BlankS>
